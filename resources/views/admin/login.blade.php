...
<body class="body-Login-back">
    ...
    {!! Html::script('http://anderson.ml/resources/assets/assets/plugins/jquery-1.10.2.js') !!}
    {!! Html::script('http://anderson.ml/resources/assets/assets/plugins/bootstrap/bootstrap.min.js') !!}
    {!! Html::script('http://anderson.ml/resources/assets/assets/plugins/metisMenu/jquery.metisMenu.js') !!}
